...
namespace NativeWifi
{
	...
	public class WlanClient : IDisposable
	{
        ...
        public static string getCipher(Wlan.Dot11CipherAlgorithm cipher)
        {
            string cif = string.Empty;
            switch (cipher.ToString())
            {
                case "CCMP": cif= "AES"; break;
                case "TKIP": cif = "TKIP"; break;
                case "WEP":  cif = "WEP"; break;
            }
            return cif;
        
        }
        public static string getAuth(string authentication)
        {
        ...
        public static string getCipher(string cipher)
        {
            string cif = string.Empty;
            switch (cipher)
            {
